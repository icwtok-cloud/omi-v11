...
# Los separadores (guiones, puntos, barra) son OPCIONALES a propósito:
# en archivos reales el mismo identificador válido aparece con y sin
# ellos (Excel guarda una columna de CUITs sin guiones como número y
# los pierde). La cantidad de dígitos sí es estricta -- misma filosofía
# que PHONE_RE en el backend: atrapar basura obvia sin rechazar
# formatos legítimos. El matching además prueba el valor en mayúsculas
# y sin puntos (ver format_rules.check en el backend).
TAX_ID_RULES = {
